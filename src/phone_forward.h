 ...
 *
 * @author Marcin Peczarski <marpe@mimuw.edu.pl>, Paweł Dec <pd438403@students.mimuw.edu.pl>
 ...
 * Wyznacza następujący ciąg numerów: Jeśli po pewnej liczbie phfwdRemove()
 * istnieje numer @p x, taki że wynik
